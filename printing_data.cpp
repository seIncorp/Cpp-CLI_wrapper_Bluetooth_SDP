...
void CLI_DEFAULT_DATA::print_data_AVRCP()
{
	...
	if (((SDP::AVRCP::AVRCP_EXPORT_S*)dd->exported_data.avrcp_export)->supported_features_handle_export != NULL)
		if (sdp_settings->print == 1 || 
			...
			avrcp_export->supported_features_handle_export->print<SDP::AVRCP::SUPPORTED_FEATURES_S::VV>(((SDP::AVRCP::AVRCP_EXPORT_S*)dd->exported_data.avrcp_export)->supported_features_handle_export->VALUE, *dd);
}
...
void CLI_DEFAULT_DATA::print_data_HFP()
{
	...
	if (((SDP::HFP::HFP_EXPORT_S*)dd->exported_data.hfp_export)->network_handle_export != NULL)
		if (sdp_settings->print == 1 || 
			...
			hfp_export->network_handle_export->print<SDP::HFP::NETWORK_S::VV>(((SDP::HFP::HFP_EXPORT_S*)dd->exported_data.hfp_export)->network_handle_export->VALUE, *dd);
	...
	if (((SDP::HFP::HFP_EXPORT_S*)dd->exported_data.hfp_export)->supported_features_handle_export != NULL)
		if (sdp_settings->print == 1 ||
			...
			sdp_settings->print_service.print_HFP_attributes_HandsfreeAudioGateway.print_supported_features == 1
				...
				hfp_export->supported_features_handle_export->print<SDP::HFP::SUPPORTED_FEATURES_S::VV>(((SDP::HFP::HFP_EXPORT_S*)dd->exported_data.hfp_export)->supported_features_handle_export->VALUE, *dd);
}
...
void CLI_DEFAULT_DATA::print_data_HSP()
{
	...
	if (((SDP::HSP::HSP_EXPORT_S*)dd->exported_data.hsp_export)->remote_audio_volume_control_handle_export != NULL)
		...
		hsp_export->remote_audio_volume_control_handle_export->print<SDP::HSP::REMOTE_AUDIO_VOLUME_CONTROL_S::VV>(((SDP::HSP::HSP_EXPORT_S*)dd->exported_data.hsp_export)->remote_audio_volume_control_handle_export->VALUE, *dd);
}
...
void CLI_DEFAULT_DATA::print_data_PNPINFO()
{
	if (((SDP::PNPINFO::INFO_EXPORT_S*)dd->exported_data.pnpinfo_export)->info_handle_export != NULL)
	{
		if (sdp_settings->print == 1 || sdp_settings->print_service.print_PNPINFO_attributes.print_pnp_info == 1)
			pnpinfo_export->info_handle_export->print<SDP::PNPINFO::INFO_S::VV>(((SDP::PNPINFO::INFO_EXPORT_S*)dd->exported_data.pnpinfo_export)->info_handle_export->VALUE, *dd);
	}
}
